...
function editAccount() {
    ...
    if (newPassword && !validateInput(passwordPattern, newPassword, 'Password must be at least 8 characters long and include both letters and numbers.')) return;
...
function editUserDetails() {
    ...
    if (password && !validateInput(passwordPattern, password, 'Password must be at least 8 characters long and include both letters and numbers.')) return;
