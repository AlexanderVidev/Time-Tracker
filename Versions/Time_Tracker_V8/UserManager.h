...
class UserManager {
private:
    vector<User> users; // Declare the users vector here
    fstream userFile;
    void loadUsers();
...
public:
    ...
    void addUser(string username, string password, string role, string userClass, int hours = 0, int minutes = 0, int seconds = 0);  // Modified to include userClass
